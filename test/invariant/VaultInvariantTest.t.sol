...
contract VaultInvariantTest is BaseTest {
    ...
    function setUp() public {
        BaseTestInit memory init = BaseTestInit({
            ...
            collateralAssets: 20 * 10 ** 19,
            borrowAssets: 350 * 10 ** 18,
            maxSafeLTV: 9 * 10 ** 17,
            ...
            borrowPrice: 10 ** 18,
            maxDeleverageFee: 0,
            // zeroAddressTokens: 200 * 2 * 10**18 - 350 * 10 ** 18
            zeroAddressTokens: 200 * 2111111111111111111 - 350 * 10 ** 18
        });
    ...
    function invariant_vault() public view {
        ...
        // console.log("futureCollateralAssets", futureCollateralAssets * 2);
        // console.log("futureRewardBorrowAssets", futureRewardBorrowAssets);
        // console.log("realBorrowAssets", realBorrowAssets);
        // console.log("futureRewardCollateralAssets", futureRewardCollateralAssets * 2);
        // console.log("realCollateralAssets", realCollateralAssets * 2);
        ...
        assertApproxEqAbs(borrow * 4 / 3, collateral, 100);
